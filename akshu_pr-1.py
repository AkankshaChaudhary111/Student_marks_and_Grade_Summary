...
# 1. Load the dataset
df = pd.read_csv('/content/drive/MyDrive/student-scores.csv')
...
grade_dist.plot(kind='pie', autopct='%1.1f%%', startangle=90, colors=['gold', 'lightgreen', 'skyblue', 'orange', 'red'])
...
# 11. Save charts as images (optional)
